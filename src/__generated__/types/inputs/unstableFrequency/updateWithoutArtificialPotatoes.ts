...
import { ReverseTransactionUpdateRelationListWithoutUnstableFrequency } from "../reverseTransaction/updateRelationListWithoutUnstableFrequency";
...
export const UnstableFrequencyUpdateWithoutArtificialPotatoes = builder.inputRef<any>("UnstableFrequencyUpdateWithoutArtificialPotatoes").implement({
  fields: (t) => ({
    ...
    reverseTransaction: t.field({
      type: ReverseTransactionUpdateRelationListWithoutUnstableFrequency,
      required: false,
    }),
