...
export const SymphonyChartCreate = builder.inputRef<any>("SymphonyChartCreate").implement({
  fields: (t) => ({
    ...
    ghostRecord: t.field({ type: GhostRecordCreateRelationWithoutSymphonyChart, required: false }),
