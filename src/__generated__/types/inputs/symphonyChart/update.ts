...
export const SymphonyChartUpdate = builder.inputRef<any>("SymphonyChartUpdate").implement({
  fields: (t) => ({
    ...
    ghostRecord: t.field({ type: GhostRecordUpdateRelationWithoutSymphonyChart, required: false }),
