...
export const SchrodingerUserCreate = builder.inputRef<any>("SchrodingerUserCreate").implement({
  fields: (t) => ({
    ...
    signalGrid: t.field({ type: SignalGridCreateRelationWithoutSchrodingerUser, required: false }),
