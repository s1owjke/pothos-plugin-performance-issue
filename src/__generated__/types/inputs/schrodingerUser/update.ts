...
export const SchrodingerUserUpdate = builder.inputRef<any>("SchrodingerUserUpdate").implement({
  fields: (t) => ({
    ...
    signalGrid: t.field({ type: SignalGridUpdateRelationWithoutSchrodingerUser, required: false }),
