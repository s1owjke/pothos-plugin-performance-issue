...
export const CosmicDebriWhere = builder.inputRef<any>("CosmicDebriWhere").implement({
  fields: (t) => ({
    ...
    AND: t.field({ type: [CosmicDebriWhere], required: false }),
    OR: t.field({ type: [CosmicDebriWhere], required: false }),
    NOT: t.field({ type: [CosmicDebriWhere], required: false }),
  }),
});
