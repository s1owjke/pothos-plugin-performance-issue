...
export const SuspiciousTimestampWhere = builder.inputRef<any>("SuspiciousTimestampWhere").implement({
  fields: (t) => ({
    ...
    AND: t.field({ type: [SuspiciousTimestampWhere], required: false }),
    OR: t.field({ type: [SuspiciousTimestampWhere], required: false }),
    NOT: t.field({ type: [SuspiciousTimestampWhere], required: false }),
  }),
});
