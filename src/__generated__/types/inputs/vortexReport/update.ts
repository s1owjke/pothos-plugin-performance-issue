...
export const VortexReportUpdate = builder.inputRef<any>("VortexReportUpdate").implement({
  fields: (t) => ({
    ...
    cosmicDebris: t.field({ type: CosmicDebriUpdateRelationWithoutVortexReport, required: false }),
    ghostRecord: t.field({ type: GhostRecordUpdateRelationWithoutVortexReports, required: false }),
    hypotheticalRevenue: t.field({
      type: HypotheticalRevenueUpdateRelationWithoutVortexReports,
      required: false,
    }),
    infiniteUndo: t.field({ type: InfiniteUndoUpdateRelationWithoutVortexReport, required: false }),
