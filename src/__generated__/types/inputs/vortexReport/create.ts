...
export const VortexReportCreate = builder.inputRef<any>("VortexReportCreate").implement({
  fields: (t) => ({
    ...
    cosmicDebris: t.field({ type: CosmicDebriCreateRelationWithoutVortexReport, required: false }),
    ghostRecord: t.field({ type: GhostRecordCreateRelationWithoutVortexReports, required: false }),
    hypotheticalRevenue: t.field({
      type: HypotheticalRevenueCreateRelationWithoutVortexReports,
      required: false,
    }),
    infiniteUndo: t.field({ type: InfiniteUndoCreateRelationWithoutVortexReport, required: false }),
