...
import { RejectedTheoryCreateRelationListWithoutThresholdManifest } from "../rejectedTheory/createRelationListWithoutThresholdManifest";
...
export const ThresholdManifestCreateWithoutDimensionalBackups = builder.inputRef<any>("ThresholdManifestCreateWithoutDimensionalBackups").implement({
  fields: (t) => ({
    ...
    rejectedTheories: t.field({
      type: RejectedTheoryCreateRelationListWithoutThresholdManifest,
      required: false,
    }),
