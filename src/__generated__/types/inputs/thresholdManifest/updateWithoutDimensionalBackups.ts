...
import { SuspiciousTimestampUpdateRelationWithoutThresholdManifest } from "../suspiciousTimestamp/updateRelationWithoutThresholdManifest";
...
export const ThresholdManifestUpdateWithoutDimensionalBackups = builder.inputRef<any>("ThresholdManifestUpdateWithoutDimensionalBackups").implement({
  fields: (t) => ({
    ...
    suspiciousTimestamp: t.field({
      type: SuspiciousTimestampUpdateRelationWithoutThresholdManifest,
      required: false,
    }),
