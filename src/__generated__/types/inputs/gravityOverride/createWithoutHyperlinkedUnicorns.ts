...
import { OverdueRevolutionCreateRelationListWithoutGravityOverride } from "../overdueRevolution/createRelationListWithoutGravityOverride";
...
export const GravityOverrideCreateWithoutHyperlinkedUnicorns = builder.inputRef<any>("GravityOverrideCreateWithoutHyperlinkedUnicorns").implement({
  fields: (t) => ({
    ...
    overdueRevolutions: t.field({
      type: OverdueRevolutionCreateRelationListWithoutGravityOverride,
      required: false,
    }),
