...
import { UnderappreciatedCommentUpdateRelationListWithoutGravityOverride } from "../underappreciatedComment/updateRelationListWithoutGravityOverride";
...
export const GravityOverrideUpdateWithoutHyperlinkedUnicorns = builder.inputRef<any>("GravityOverrideUpdateWithoutHyperlinkedUnicorns").implement({
  fields: (t) => ({
    ...
    underappreciatedComments: t.field({
      type: UnderappreciatedCommentUpdateRelationListWithoutGravityOverride,
      required: false,
    }),
